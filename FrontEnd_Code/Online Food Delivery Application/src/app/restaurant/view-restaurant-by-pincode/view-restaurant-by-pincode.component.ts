...
@Component({
  selector: 'app-view-restaurant-by-pincode',
  templateUrl: './view-restaurant-by-pincode.component.html',
  styleUrls: ['./view-restaurant-by-pincode.component.css']
})
export class ViewRestaurantByPincodeComponent implements OnInit {
