...
@Component({
  selector: 'app-view-items-by-name',
  templateUrl: './view-items-by-name.component.html',
  styleUrls: ['./view-items-by-name.component.css']
})
export class ViewItemsByNameComponent implements OnInit {
