...
export class ItemServiceService {
 ...
 getItem(){
  ...
  private addItem_endpoint=this.endpoint+'additem';
   ...
   doAddItem(item:Item):Observable<Object>{
    console.log('Item Service - Add Item Called');
    let opt=this.http.post<Item>(this.addItem_endpoint,item);
    if(opt){
